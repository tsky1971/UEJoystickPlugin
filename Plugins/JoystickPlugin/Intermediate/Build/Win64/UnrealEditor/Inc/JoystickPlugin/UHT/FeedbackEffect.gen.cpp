...
template<> JOYSTICKPLUGIN_API UScriptStruct* StaticStruct<FFeedbackData>()
{
	...
	struct Z_CompiledInDeferFile_FID_UE_Creates_CreateJoystick_UE53_Plugins_JoystickPlugin_Source_JoystickPlugin_Public_FeedbackEffect_h_Statics
	{
		static const FEnumRegisterCompiledInInfo EnumInfo[];
		static const FStructRegisterCompiledInInfo ScriptStructInfo[];
	};
	const FEnumRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UE_Creates_CreateJoystick_UE53_Plugins_JoystickPlugin_Source_JoystickPlugin_Public_FeedbackEffect_h_Statics::EnumInfo[] = {
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UE_Creates_CreateJoystick_UE53_Plugins_JoystickPlugin_Source_JoystickPlugin_Public_FeedbackEffect_h_Statics::ScriptStructInfo[] = {
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UE_Creates_CreateJoystick_UE53_Plugins_JoystickPlugin_Source_JoystickPlugin_Public_FeedbackEffect_h_1330088760(TEXT("/Script/JoystickPlugin"),
		nullptr, 0,
		Z_CompiledInDeferFile_FID_UE_Creates_CreateJoystick_UE53_Plugins_JoystickPlugin_Source_JoystickPlugin_Public_FeedbackEffect_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_UE_Creates_CreateJoystick_UE53_Plugins_JoystickPlugin_Source_JoystickPlugin_Public_FeedbackEffect_h_Statics::ScriptStructInfo),
		Z_CompiledInDeferFile_FID_UE_Creates_CreateJoystick_UE53_Plugins_JoystickPlugin_Source_JoystickPlugin_Public_FeedbackEffect_h_Statics::EnumInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_UE_Creates_CreateJoystick_UE53_Plugins_JoystickPlugin_Source_JoystickPlugin_Public_FeedbackEffect_h_Statics::EnumInfo));
