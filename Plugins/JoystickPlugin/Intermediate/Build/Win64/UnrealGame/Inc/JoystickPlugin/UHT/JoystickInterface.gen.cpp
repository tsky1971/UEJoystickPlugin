...
// End Cross Module References
	...
	static UEnum* EJoystickInputType_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_EJoystickInputType.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_JoystickPlugin_EJoystickInputType, Z_Construct_UPackage__Script_JoystickPlugin(), TEXT("EJoystickInputType"));
		}
	...
	static UEnum* EJoystickPOVDirection_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_EJoystickPOVDirection.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_JoystickPlugin_EJoystickPOVDirection, Z_Construct_UPackage__Script_JoystickPlugin(), TEXT("EJoystickPOVDirection"));
		}
...
class UScriptStruct* FJoystickState::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_JoystickState.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FJoystickState, Z_Construct_UPackage__Script_JoystickPlugin(), TEXT("JoystickState"));
	}
...
class UScriptStruct* FJoystickInfo::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_JoystickInfo.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FJoystickInfo, Z_Construct_UPackage__Script_JoystickPlugin(), TEXT("JoystickInfo"));
	}
...
template<> JOYSTICKPLUGIN_API UScriptStruct* StaticStruct<FJoystickInfo>()
{
	...
	struct Z_CompiledInDeferFile_FID_CreateJoystick_UE51_Plugins_JoystickPlugin_Source_JoystickPlugin_Public_JoystickInterface_h_Statics
	{
		static const FEnumRegisterCompiledInInfo EnumInfo[];
		static const FStructRegisterCompiledInInfo ScriptStructInfo[];
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FEnumRegisterCompiledInInfo Z_CompiledInDeferFile_FID_CreateJoystick_UE51_Plugins_JoystickPlugin_Source_JoystickPlugin_Public_JoystickInterface_h_Statics::EnumInfo[] = {
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_CreateJoystick_UE51_Plugins_JoystickPlugin_Source_JoystickPlugin_Public_JoystickInterface_h_Statics::ScriptStructInfo[] = {
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_CreateJoystick_UE51_Plugins_JoystickPlugin_Source_JoystickPlugin_Public_JoystickInterface_h_Statics::ClassInfo[] = {
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_CreateJoystick_UE51_Plugins_JoystickPlugin_Source_JoystickPlugin_Public_JoystickInterface_h_2944720999(TEXT("/Script/JoystickPlugin"),
		Z_CompiledInDeferFile_FID_CreateJoystick_UE51_Plugins_JoystickPlugin_Source_JoystickPlugin_Public_JoystickInterface_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_CreateJoystick_UE51_Plugins_JoystickPlugin_Source_JoystickPlugin_Public_JoystickInterface_h_Statics::ClassInfo),
		Z_CompiledInDeferFile_FID_CreateJoystick_UE51_Plugins_JoystickPlugin_Source_JoystickPlugin_Public_JoystickInterface_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_CreateJoystick_UE51_Plugins_JoystickPlugin_Source_JoystickPlugin_Public_JoystickInterface_h_Statics::ScriptStructInfo),
		Z_CompiledInDeferFile_FID_CreateJoystick_UE51_Plugins_JoystickPlugin_Source_JoystickPlugin_Public_JoystickInterface_h_Statics::EnumInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_CreateJoystick_UE51_Plugins_JoystickPlugin_Source_JoystickPlugin_Public_JoystickInterface_h_Statics::EnumInfo));
