...
"C:\Program Files\Microsoft Visual Studio\2022\Enterprise\MSBuild\Current\Bin\MSBuild.exe" sdl3.sln /t:SDL3-static /p:Configuration="Release"
...
echo "copy libs/inc"
xcopy include\*.* ..\SDL3extern\include\ /V /S /E /Y
xcopy Release\*.* ..\SDL3extern\Lib\ /V /S /E /Y
...
xcopy %SDL_DIR%\include\*.* SDL3extern\include\ /V /S /E /Y
